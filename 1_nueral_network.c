...
/*creat a ramdom number between low and high
     low + rand() % (High-Low+1)
rand() % (High-Low+1) is a number that no bigger
than high-low+1 .so low + rand() % (High-Low+1)
is a number bigger than low but smaller than high
                                          */
